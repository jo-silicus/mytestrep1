...
<html:form action="/PasswordReminder">
...
<table width="978" border="0">
  <tr>
    <td width="152" bordercolor="#FFFFFF"  bgcolor="#023F70"><span class="style1"><a href="/execmap" class="style1"><bean:message bundle="execmap" key="home.title" /></a>><bean:message bundle="execmap" key="forgetpassword.title" /></span></td>
...
<table width="979" border="0">
  <tr>
    <td width="973"><DIV align=justify class="style8">
      <p><bean:message bundle="execmap" key="forgetpassword.msg" /></p>
        </DIV></td>
  </tr>
</table>
<p>&nbsp;</p>
...
<table width="750" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="263"> <div align="right" class="style17"><bean:message bundle="execmap" key="label.login.registered.email" />:</div></td><td width="487"><p>
        <html:text property="email" size="17"  style="background-color: #FFFF66;" />
      </p></td>
  </tr>
</table>
<p>&nbsp;</p>

...
<tiles:insert page="/pages/layout/mainlayout.jsp" flush="true">
   ...
   <tiles:put name="whereami" value="/pages/common/whereami.jsp?test=Home>Forgot Password>Forgot Password Conformation" />
   <tiles:put name="content" value="/forgetconfirmationcontent.jsp" />

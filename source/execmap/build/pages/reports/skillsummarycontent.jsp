...
<html:form action="/SkillSummaryReport.do">
  <bean:define id="skillSummaryReportModel" name="SkillSummaryForm" property="skillSummaryReportModel" type="com.mgmtassessment.execmap.business.model.SkillSummaryReportModel"/>
  <p align="left">&nbsp;</p>

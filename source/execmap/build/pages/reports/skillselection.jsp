<%-- 
  ...
  - All Rights Reserved.
  - @(#)
  - Description: This jsp contains skillselectioncontent.jsp which is used to display all the skills from which a 
...
<tiles:insert page="/pages/layout/reportlayout.jsp" flush="true">
   ...
   <tiles:put name="content" value="/pages/reports/skillselectioncontent.jsp" />

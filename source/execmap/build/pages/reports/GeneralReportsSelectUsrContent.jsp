...
<script type="text/javascript">
   ...
   function a()
   {
   document.forms[0].action="/execmap/GeneralReports.do?acctId=<bean:write name="SelectUserForm" property="acctId" />&usrId=<bean:write name="SelectUserForm" property="usrId" />&actvId=64";
   }
   </script>
<p>&nbsp;</p>

...
<table width="708" border="0" cellpadding="0" cellspacing="0">
 ...
 <logic:iterate id="resultList" name="UserSearchForm" property="userList" type="com.mgmtassessment.execmap.data.dao.types.CompanyUserMaster">
  <script>
    if(countRows%4 == 0)
   {
	document.write("<tr>");
	...
	<bean:define id="userAccountKey" name="userAccount" property="comp_id" type="com.mgmtassessment.execmap.data.dao.types.CompanyUserMasterKey"/>

...
<table width="700" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="302"><p align="right"><bean:message bundle="execmap" key="adminaddcompany.remindphrase.label" />: 
        <html:text name="UserAccountForm" property="userReminderPhrase" maxlength="50" readonly="true" style="background-color: #CCCCCC;"/>
    </p></td>
    <td width="438">&nbsp;</td>
  </tr>
</table>
...
<table width="708" border="0" cellpadding="0" cellspacing="0">
  <tr>
  <td width="150"><div align="right"><bean:message bundle="execmap" key="adminedituser.frmcomusrcr.notes1.value" />:&nbsp;
  </div></td> 

...
<%number=numberarray[index];
   index++;%>
		...
		<table border="3">
     		  <td><html:text property="text1" size="5" maxlength="1" disabled ="true" value='<%=""+number.charAt(0)%>'/></td>
	 		  <td><html:text property="text2" size="5" maxlength="1" disabled ="true" value='<%=""+number.charAt(1)%>'/></td>
	 		  <td><html:text property="text3" size="5" maxlength="1" disabled ="true" value='<%=""+number.charAt(2)%>'/></td>
			  <td><html:text property="text4" size="5" maxlength="1" disabled ="true" value='<%=""+number.charAt(3)%>'/></td>
	 		  <td><html:text property="text5" size="5" maxlength="1" disabled ="true" value='<%=""+number.charAt(4)%>'/></td>
	 	</table>
    ...
    <img src="/execmap/css/bluecurve/up.jpg" width="53" height="47" align="bottom" onClick="increasecheck();">
    <img src="/execmap/css/bluecurve/down.jpg" width="49" height="47" align="top" onClick="decreasecheck();">
    </td></tr>
	</table>
</logic:notEmpty>

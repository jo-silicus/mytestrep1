...
document.forms[0].action="/execmap/InitNMTX.do";
}
...
document.forms[0].enableScript.value="Enabled";
	paramval=obj.value;
	document.forms[0].action="/execmap/InitNMTX.do?"+paramval;
}
...
<logic:iterate id="choicetextorurl" name="AssessmentForm" property="textOrUrl" length="1">
<br><big>
<bean:write name="choicetextorurl"/>
</big>
</logic:iterate>
<logic:iterate id="choicetextorurl" name="AssessmentForm" property="textOrUrl" length="1" offset="1">
<br><big>
<bean:write name="choicetextorurl"/>
</big>
</logic:iterate>
...
<bean:define id="questionOptions" name="AssessmentForm" property="questionOptions"/>
    ...
    <logic:iterate id="choice" name="questionOptions" offset="1">
...
<logic:equal name="pageNo" value="0">
<Big><b>
<bean:write name="AssessmentForm" property="answerInstruction"/></div>
</b></Big>
</logic:equal>

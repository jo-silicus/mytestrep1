...
/**
 * TestSesScrDetKey generated by hbm2java
 */

public class TestSesScrDetKey  implements java.io.Serializable {
    ...
    /** default constructor */
    public TestSesScrDetKey() {
    }

    
    /** full constructor */
    public TestSesScrDetKey(String acctId, Integer sesId, String triId, String subTestId) {
        this.acctId = acctId;
        this.sesId = sesId;
        this.triId = triId;

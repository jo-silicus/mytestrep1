...
/**
 * The class is implementation of <strong>Action</strong> that adds the group
 * to a given company.
 */
...
public class GroupAccountAction
     ...
     * executing the action to add the group for the required company.
     *
     * @param mapping

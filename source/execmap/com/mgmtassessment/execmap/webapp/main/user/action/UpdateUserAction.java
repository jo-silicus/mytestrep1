...
/**
 * The class is implementation of <strong>Action</strong> that updates the user
 * to a given company and a group.
 */

public class UpdateUserAction extends ExecmapAction {

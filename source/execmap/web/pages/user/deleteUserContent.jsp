...
<table width="978" border="1" cellpadding="0" bordercolor="#003366">
  ...
  <logic:iterate id="DisplayDetails"  name="ShowDisabledUsersForm" property="listOfDisabledUsers" type="com.mgmtassessment.execmap.data.dao.types.CompanyAcctMaster">
  ...
  <html:hidden name="ShowDisabledUsersForm" property="accountId" value='<%=(String)companyAccountID%>'/>
   ...
   <html:hidden name="ShowDisabledUsersForm" property="groupId" value='<%=(String)groupId%>'/>
      ...
      <bean:define  id="actvRolId" name="Displayusers" property="actvRolMa" type="com.mgmtassessment.execmap.data.dao.types.ActvRolMaster"/>
  ...
  <bean:write name="compositeKey" property="usrId"/>
      ...
      <td width="13%" ><bean:write name="compositeKey" property="usrId"/></p></td>
      <td width="13%" ><bean:write name="Displayusers" property="firstName"/> <bean:write name="Displayusers" property="lastName"/>  </p></td>

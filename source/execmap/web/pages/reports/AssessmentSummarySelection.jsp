<%-- 
  ...
  - All Rights Reserved.
  - @(#)
  - Description: This jsp contains AssessSummReportSelectContent.jsp which is used to select group for which assessment summary report
  - has to be displayed
 --%>
<%@ page language="java" %>
...
<tiles:insert page="/pages/layout/reportlayout.jsp" flush="true">
   ...
   <tiles:put name="content" value="/pages/reports/AssessSummReportSelectContent.jsp" />

...
<html:form action="/GeneralReportsSelectGrp">
...
<script type="text/javascript">
   ...
   function a()
   {
   document.forms[0].action="/execmap/AssessmentSummaryReport.do?acctId=<bean:write name="SelectGroupForm" property="acctId" />&grpId=<bean:write name="SelectGroupForm" property="grpId" />";
   }
   </script>
<p>&nbsp;</p>

<%-- 
  ...
  - All Rights Reserved.
  - @(#)
  - Description: This jsp contains enableddisabledcompaniescontent.jsp is used to display all the enabled or disabled companies to the global manager
 --%>
...
<tiles:insert page="/pages/layout/reportlayout.jsp" flush="true">
   ...
   <tiles:put name="content" value="/pages/reports/enableddisabledcompaniescontent.jsp" />

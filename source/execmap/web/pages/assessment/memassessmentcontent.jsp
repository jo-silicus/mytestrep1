...
document.forms[0].action="/execmap/InitMEMX.do";
}
...
{
	paramval=obj.value;
	document.forms[0].action="/execmap/InitMEMX.do?"+paramval;
}
function StartMediaUp (surl)
{
  document.Player.URL = surl;
...
<table width="500" height="96" border="1" align="center">
            <tr><td align="middle">
         		  <span class="style4">
...
<logic:equal name="pageNo" value="7">
<table width="500" height="96" border="1" align="center">
            <tr><td align="middle">
         		  <span class="style4">
                  <bean:write name="AssessmentMultiForm" property="answerInstruction"/>
...
<logic:notEqual name="pageNo" value="12">
<logic:notEqual name="pageNo" value="13">
<logic:notEqual name="pageNo" value="15">
<logic:notEqual name="pageNo" value="16">
<div align="center">
		 <span class="style2">
         <bean:write name="AssessmentMultiForm" property="answerInstruction"/>
         </span>
...
<logic:notEqual name="pageNo" value="11">
<logic:notEqual name="pageNo" value="14">
<div align="center">
         <span class="style6">
         <bean:write name="AssessmentMultiForm" property="answerInstruction"/>
         </span>
...
<span id=dummyspan></span><div align="center">
...
<bean:define id="Play">
<bean:message bundle="execmap" key="generic.play_sound" />
</bean:define>
<input type="Button" onClick='javascript:StartMediaUp("<%=choiceinstruction%>");' value="<%=Play%>"/>
...
<logic:equal name="pageNo" value="10">
<logic:notEmpty name="AssessmentMultiForm" property="textOrUrl">
<logic:iterate id="number" name="AssessmentMultiForm" property="textOrUrl">
<b><div align="center">
<span class="style2"><bean:write name="number"/></span>
...
<div align="center">
<P>
<html:text name="AssessmentMultiForm" property="textbox0" maxlength="1" onclick="javascript:setNumericalValue(0);" size="1"/>
<html:text name="AssessmentMultiForm" property="textbox1" maxlength="1" onclick="javascript:setNumericalValue(1);" size="1"/>
<html:text name="AssessmentMultiForm" property="textbox2" maxlength="1" onclick="javascript:setNumericalValue(2);" size="1"/>
<html:text name="AssessmentMultiForm" property="textbox3" maxlength="1" onclick="javascript:setNumericalValue(3);" size="1"/>
<logic:equal name="pageNo" value="9">
<html:text name="AssessmentMultiForm" property="textbox4" maxlength="1" onclick="javascript:setNumericalValue(4);" size="1"/>
</logic:equal>
<logic:equal name="pageNo" value="12">
<html:text name="AssessmentMultiForm" property="textbox4" maxlength="1" onclick="javascript:setNumericalValue(4);" size="1"/>
</logic:equal>
...
<logic:greaterThan name="pageNo" value="12">

...
<table width=85%  cellpadding=2 cellspacing=0>
	...
	<logic:equal name="rptId"  value="4">
	<tr>  
		<td width=18%>&nbsp;</td>
	    <td align=left width="78%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
    	<a href="LeadershipEMenu.do?rptId=3"><bean:message bundle="execmap" key="adminoptions.leadership.management.analysis.report"/></a></td></tr>
    <tr>
    </logic:equal>
</table>

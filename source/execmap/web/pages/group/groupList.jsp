...
<table width="708" border="0" cellpadding="0" cellspacing="0">
 ...
 <logic:iterate id="resultList" name="GroupSearchForm" property="groupList" type="com.mgmtassessment.execmap.data.dao.types.CompanyGroupMaster">
  <script>
    if(countRows%4 == 0)
   {
	document.write("<tr>");
	...
	<bean:define id="groupAccountKey" name="groupAccount" property="comp_id" type="com.mgmtassessment.execmap.data.dao.types.CompanyGroupMasterKey"/>
...
<table width="978" border="0" align="left" cellpadding="0" cellspacing="0" bgcolor="#009966">
  ...
  <tr>
    ...
    <td width="409" bgcolor="#023F70"><div align="left">
         ...
         <logic:iterate id="resultList" name="GroupSearchForm" property="totalGroupList" type="com.mgmtassessment.execmap.data.dao.types.CompanyGroupMaster">
        <bean:define id="groupAccount" name="resultList"/>
     	<bean:define id="groupAccountKey" name="groupAccount" property="comp_id" type="com.mgmtassessment.execmap.data.dao.types.CompanyGroupMasterKey"/>
     	<bean:define id="groupAccountID" name="groupAccountKey" property="grpId"/>

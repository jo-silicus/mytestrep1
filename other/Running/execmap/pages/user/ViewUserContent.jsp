...
<table width="708" border="0" cellpadding="0" cellspacing="0">
  <tr>
  <td width="175"><div align="right"><bean:message bundle="execmap" key="adminedituser.frmcomusrcr.notes1.value" />:&nbsp;
  </div></td> 
    <td width="533"><div align="left"><html:textarea  name="UserAccountForm" property="userNotes" disabled="true"/></div></td>
    </tr>
</table>
<p>&nbsp;</p>
<p>&nbsp;</p>

...
<b><big><bean:write name="instruction"/></big></b>
</logic:iterate>
<logic:iterate id="instruction" name="AssessmentForm" property="instruction" offset="1" length="1">
<big><bean:write name="instruction"/></big>
</logic:iterate>
</logic:equal>	

<logic:iterate id="questImgPath" name="AssessmentForm" property="textOrUrl">
AssessmentForm<table width="935" border="0">
  <tr>
    <td width="200">
    ...
    <td width="734">
    <logic:notEqual name="pageNo" value="0">
    <Big><bean:write name="AssessmentForm" property="answerInstruction"/></big>
    </logic:notEqual>
    <div align="left">
    ...
    <logic:equal name="pageNo" value="0">
    <logic:iterate id="instruction" name="AssessmentForm" property="instruction" offset="2" length="1">
    <big><bean:write name="instruction"/></big>
    </logic:iterate>
    </logic:equal>
    </div>
...
<logic:equal name="pageNo" value="0">
<big><strong><bean:write name="AssessmentForm" property="answerInstruction"/></big></strong>
</logic:equal>
<p>&nbsp;</p>

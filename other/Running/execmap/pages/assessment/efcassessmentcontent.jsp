...
document.forms[0].action="/execmap/InitEFCX.do";
}
...
function setnavigateQuestion()
{
	document.forms[0].enableScript.value="Enabled";
	paramval=obj.value;
	document.forms[0].action="/execmap/InitEFCX.do?"+paramval;
}
...
<logic:iterate id="choiceinstruction" name="AssessmentForm" property="instruction" length="1">

<big><b><bean:write name="choiceinstruction"/></b></big>
</logic:iterate>

<logic:iterate id="choiceinstruction" name="AssessmentForm" property="instruction" offset="1">
<big><bean:write name="choiceinstruction"/></big>
</logic:iterate>
</logic:equal>	

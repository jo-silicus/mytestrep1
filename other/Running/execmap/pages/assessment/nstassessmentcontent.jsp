...
<logic:iterate id="choiceinstruction" name="AssessmentMultiForm" property="instruction" length="2">

<font size="3"><b><bean:write name="choiceinstruction"/></b></font>

</logic:iterate>
<br><br>
<logic:iterate id="choiceinstruction" name="AssessmentMultiForm" property="instruction" offset="2">
...
<html:submit onclick="javascript:resume();enableJavaScript();"><bean:message bundle="execmap" key="generic.resume" /></html:submit>
</logic:equal>
</logic:notEqual>

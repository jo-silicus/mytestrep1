...
{
  document.forms[0].Player.URL = surl;
  document.forms[0].Player.controls.play();
}
...
<input type="Button" onClick='javascript:countDown1();StartMediaUp("<%=choiceinstruction%>");' value="<%=Play%>"/>

...
document.forms[0].action="/execmap/InitCFSX.do";
}
...
{	clearTimeout(ticker);
	document.forms[0].enableScript.value="Enabled";
	paramval=obj.value;
	document.forms[0].action="/execmap/InitCFSX.do?"+paramval;
}
...
<logic:iterate id="instruction" name="AssessmentForm" property="instruction" length="3" offset="1">
<big>
<bean:write name="instruction"/>
</big>
</logic:iterate>
<logic:iterate id="instruction" name="AssessmentForm" property="instruction" offset="5">
<big>
<br><br>
<bean:write name="instruction"/>
</big>

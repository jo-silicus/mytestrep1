...
{
	document.forms[0].enableScript.value="Enabled";
	var url_image="<%=request.getContextPath()%>/ShowImageList.do";
	window.open(url_image,'imagelist',"height=400,width=600,toolbar=no,directories=no,status=yes,menubar=no,scrollbars=yes,resizable=no,left=200,top=25");

...
{
	enableJavaScript();
	document.forms[0].action="/execmap/SendCompanyEmail.do";
}

<!-- change end here -->
</script>

<html:form action="/updatecompany">
...
<html:hidden name="CompanyAccountForm" property="companyAcctId"  />
<html:hidden name="CompanyAccountForm" property="enableDisable"  />
...
<table width="708" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="320"><div align="right">
      <html:text name="CompanyAccountForm" property="companyAddr2" />
</div></td>
...
<table width="708" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <!-- change made here  25/09/06 -->   
 <div align="left">
     <html:submit onclick="SendCompanyEmail();"><bean:message bundle="execmap" key="generic.sendEmail" /></html:submit>
    </div>
...
<table width="780" border="0">
  <tr>
    ...
    <td><input type=button value="Browse.." onclick="javascript:openImageListWin();" /></td>
  </tr>
</table>
...
<table width="780" border="0">
  <tr>
    ...
    <html:select  name="CompanyAccountForm" property="companyReportFormat" > 
       <html:option value="1">ExecMap Individual Report</html:option>
       <html:option value="2">ExecMap Leadership A Report</html:option>
       <html:option value="3">ExecMap Leadership B Report</html:option>
       <html:option value="4">ExecMap Summary Report</html:option>
    </html:select>
     </div></td>
  </tr>
</table>
...
function resetedit()
{
	...
	document.forms[0].action="/execmap/EditCompanyAction.do?acctId="+document.forms[0].companyAcctId.value;
...
<table width="978" border="0" align="left" cellpadding="0" cellspacing="0" bgcolor="#009966">
  <tr>
    <td width="409" bgcolor="#023F70"><div align="left">
          <div align="center">
          <html:submit onclick="javascript:editingcompany();" ><bean:message bundle="execmap" key="generic.submit" /></html:submit>
             
          </div>
    </div></td>
    <td width="399" bgcolor="#023F70">
      <div align="center">
         <html:submit onclick="javascript:resetedit();"><bean:message bundle="execmap" key="generic.reset"  /></html:submit>
      </div>
</td>
  </tr>
</table>

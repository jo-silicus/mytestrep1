...
<bean:define id="statusbarurl" name="AssessmentForm" property="statusBarUrl"/> 
<table width="980" bordercolor="#0000FF">
    <tr>
      <td bordercolor="#0000FF"><img src="<%=statusbarurl%>" height="22"></td>
    </tr>
  </table>
                ...
                <td width="100%" bgColor=#023f70><div class=style6 align=left>
                    <div class=style8 align=center>
                      <div align=center class=style5>
                       ...
                       <bean:write name="AssessmentForm" property="subHeader" />

...
<table width="978" border="1" cellpadding="0" bordercolor="#003366">
  ...
  <logic:iterate id="DisplayDetails"  name="DeleteDisableGroupForm" property="listOfDisabledGroups" type="com.perot.intellicue.data.dao.types.CompanyAcctMaster">
 ...
 <bean:define id="actv_rol_id" name="Displayusers" property="actvRolMa" type="com.perot.intellicue.data.dao.types.ActvRolMaster"/>
 ...
 <logic:empty  name="DeleteDisableGroupForm" property="listOfDisabledGroups">
   <p align="center"><bean:message bundle="execmap" key="msg.group.delete.disabled.group"/></p>
  </logic:empty>
 <logic:notEmpty  name="DeleteDisableGroupForm" property="listOfDisabledGroups">

<%-- 
  ...
  - @(#)
  - Description: 
  - This page is the content part of editGroup.jsp which
...
{
	enableJavaScript()
	document.forms[0].action="/execmap/SendGroupEmailAction.do";
}
</script>
<!-- end here -->
<p align="left">&nbsp;</p>
...
<table width="978" border="0" align="left" bordercolor="#FFFFFF" bgcolor="#023F70">
  ...
  <bean:message bundle="execmap" key="adminoptions.groupmanagement" />
   ...
   ><bean:message bundle="execmap" key="generic.Update_Group" />
   </td>
     <td >
...
<html:form  action="/updateGroupAction">
...
<table width="708" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <!-- changes made here 25/09/06 -->

    <td width="100">
    <div align="left">
     <html:submit onclick="SendGroupEmail();"><bean:message bundle="execmap" key="generic.sendEmail" /></html:submit>
    </div>
    </td>
<!-- chanage ende here -->

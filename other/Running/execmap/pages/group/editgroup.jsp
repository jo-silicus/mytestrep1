<%-- 
  ...
  - @(#)
  - Description: 
  - This page shows the interface to edit
  - a group record.The page is invoked by add action on search group Page.
  -
  --%>
...
<tiles:insert page="/pages/layout/mainlayout.jsp" flush="true">
   ...
   <tiles:put name="content" value="/pages/group/editGroupContent.jsp" />

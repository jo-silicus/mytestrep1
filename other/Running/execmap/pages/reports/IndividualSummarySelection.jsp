<%-- 
  ...
  - All Rights Reserved.
  - @(#)
  - Description: This jsp contains IndividualReportSelectionContent.jsp which is used to select user whose report has to be displayed
 --%>
<%@ page language="java" %>
...
<tiles:insert page="/pages/layout/reportlayout.jsp" flush="true">
   ...
   <tiles:put name="content" value="/pages/reports/IndividualReportSelectionContent.jsp" />

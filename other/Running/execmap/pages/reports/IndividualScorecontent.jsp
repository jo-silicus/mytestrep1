...
<br>
<table width="978" border="0"><tr><td align="right"> <html:link href="javascript:excel();"><img src="/execmap/images/main/excel.GIF"><bean:message bundle="execmap" key="view.in.msexcel" /></html:link></td></tr></table>		
<table width="978" border="1" cellpadding="0" cellspacing="0" >
 <tr bgcolor="#006699">
  <td width="25%" bgcolor="#023F70" align="left"><span class="style1">
...
<table width="978" border="1" bordercolor="#003366">			
 <tr bgcolor="#006699">
  <td width="25%" height="21" bgcolor="#023F70" align="center"><span class="style1">
  ...
  <td width="25%" height="21" bgcolor="#023F70" align="center"><span class="style1">
	 <bean:message bundle="execmap" key="admininduserreport.deviation" /></span>
  </td>
 </tr>
 <logic:iterate id="userscoreinfo" name="IndividualSummaryReportForm" property="userScoreDetails">
  <tr>
   <td align=center height=21 width="25%">   
   ...
   <td align=center height=21 width="25%">
	    &nbsp;&nbsp;
   		<bean:write name="userscoreinfo" property="deviation"/>
   </td>
  </tr>
 </logic:iterate>
</table>

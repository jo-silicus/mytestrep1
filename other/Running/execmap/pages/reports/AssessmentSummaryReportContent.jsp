...
<table width="978" border="1" cellpadding="0" bordercolor="#003366">
  ...
  <logic:iterate id="AssessmentSummaryDetails" name="AssessmentSummaryForm" property="assessmentSummaryDetails" type="com.perot.intellicue.business.model.AssessmentSummaryModel">
  <tr>

...
<p align="left">&nbsp;</p>
	...
	<p>&nbsp;</p>
	<table>
		<tr><td width="300" align="center">	<a href="javascript:html();" align="center"><img src="/execmap/images/main/ie.GIF"><bean:message bundle="execmap" key="click.here.view" /> html</a></td><br><br>
		<td width="300" align="center">	<a href="javascript:word();" align="center"><img src="/execmap/images/main/word.GIF"><bean:message bundle="execmap" key="click.here.view" /> word</a></td><br><br>
		<td width="300" align="center"><html:link href="javascript:pdf();" ><img src="/execmap/images/main/adobe.gif"><bean:message bundle="execmap" key="click.here.view" /> pdf </html:link></td></tr>
	</table>
</logic:notEmpty>
</html:form> 
<p>&nbsp;</p>

...
<tiles:insert page="/pages/layout/mainlayout.jsp" flush="true">
   ...
   <tiles:put name="whereami" value="/pages/common/whereami.jsp?test=Home>Change Password>Change Password Conformation" />
   <tiles:put name="content" value="/changeconformationcontent.jsp" />
